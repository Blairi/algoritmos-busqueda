...
ax1.plot(Aax1_elementos, Aax1_times, label = 'Caso promedio', marker = '*', color = 'b')
ax1.plot(Bax1_elementos, Bax1_times, label = 'Mejor caso', marker = 'o', color = 'g')
ax1.plot(Cax1_elementos, Cax1_times, label = 'Peor caso', marker = 'x', color = 'r')

ax2.set_title("Búsq. bin. iterativa con ord. bubble sort")
ax2.plot(Aax2_elementos, Aax2_times, label = 'Caso promedio', marker = '*', color = 'b')
ax2.plot(Bax2_elementos, Bax2_times, label = 'Mejor caso', marker = 'o', color = 'g')
ax2.plot(Cax2_elementos, Cax2_times, label = 'Peor caso', marker = 'x', color = 'r')

ax3.set_title("Búsq. bin. recursiva con ord. merge sort")
ax3.plot(Aax3_elementos, Aax3_times, label = 'Caso promedio', marker = '*', color = 'b')
ax3.plot(Bax3_elementos, Bax3_times, label = 'Mejor caso', marker = 'o', color = 'g')
ax3.plot(Cax3_elementos, Cax3_times, label = 'Peor caso', marker = 'x', color = 'r')

ax4.set_title("Búsq. bin. iterativa con ord. merge sort")
ax4.plot(Aax4_elementos, Aax4_times, label = 'Caso promedio', marker = '*', color = 'b')
ax4.plot(Bax4_elementos, Bax4_times, label = 'Mejor caso', marker = 'o', color = 'g')
ax4.plot(Cax4_elementos, Cax4_times, label = 'Peor caso', marker = 'x', color = 'r')

ax5.set_title("Búsq. lineal iterativa")
ax5.plot(Aax5_elementos, Aax5_times, label = 'Caso promedio', marker = '*', color = 'b')
ax5.plot(Bax5_elementos, Bax5_times, label = 'Mejor caso', marker = 'o', color = 'g')
ax5.plot(Cax5_elementos, Cax5_times, label = 'Peor caso', marker = 'x', color = 'r')

ax6.set_title("Búsq. lineal recursiva")
ax6.plot(Aax6_elementos, Aax6_times, label = 'Caso promedio', marker = '*', color = 'b')
ax6.plot(Bax6_elementos, Bax6_times, label = 'Mejor caso', marker = 'o', color = 'g')
ax6.plot(Cax6_elementos, Cax6_times, label = 'Peor caso', marker = 'x', color = 'r')
...
ax4.set_xlabel('Elementos')
ax4.legend(loc=2)

ax5.set_ylabel('Veces que entra')
ax5.set_xlabel('Elementos')
ax5.legend(loc=2)

ax6.set_ylabel('Veces que entra')
ax6.set_xlabel('Elementos')
ax6.legend(loc=2)
